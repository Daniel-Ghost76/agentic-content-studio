...
|-------|------|----------|-----------|-------------|
| 1 | Ideation | Claude | `Input/1. Sub-agents/1. ideation_sub-agent.md` | `Output/1. Ideation/{project_id}/` |
| 2 | Scripts | Claude | `Input/1. Sub-agents/2. scripting_sub-agent.md` | `Output/2. Scripts/{project_id}/` |
...
| 4 | Editing | Claude | `Input/1. Sub-agents/4. editing_sub-agent.md` | `Output/4. Editing/{project_id}/` |
| 4a | Cut Edit | Claude | `Input/1. Sub-agents/4a. cut_edit_sub-agent.md` | `Output/4. Editing/{project_id}/{project_id}_cut.mp4` |
...
| 6 | Review | Claude | `Input/1. Sub-agents/6. review_sub-agent.md` | `Output/6. Review  /{project_id}/` |
| 7 | Publishing | Claude / Astra (mobile) | `Input/1. Sub-agents/7. publishing_sub-agent.md` | `Output/7. Publishing/{project_id}/` |
| 8 | Distribution | Claude | `Input/1. Sub-agents/8. distribution_sub-agent.md` | `Output/8. Distribution/{project_id}/` |
| 9 | Analytics | Claude | `Input/1. Sub-agents/9. analytics_sub-agent.md` | `Output/9. Analytics/{project_id}/` |
