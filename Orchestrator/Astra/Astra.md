...
Daniel's business plan: `Orchestrator/Skills/strategy_skill.md` — goal, funnel, the product (inbound lead-response + booking AI agent), Phase 1/2, how first clients are sourced, and what's still open. Read it before any planning, outreach, offer, or content-direction call. Pairs with the Schedule Skill.
